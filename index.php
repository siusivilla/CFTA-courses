...
<div class="container">
  <div class="row text-center">
    <div class="col-12 col-sm-8 offset-sm-2">
      <h3>Interessato alle ultime novità su come risolvere i propri problemi in maniera pulita?</h3>
      <p class="lead">Iscriviti alla newsletter KillerNews!</p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-6 offset-sm-3">
      ...
      <form action="https://gmail.us20.list-manage.com/subscribe/post?u=bdc98a5010a89bde6f999f27b&amp;id=7c22a8877b" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        <div id="mc_embed_signup_scroll">
          <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required>
          <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
          <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_bdc98a5010a89bde6f999f27b_7c22a8877b" tabindex="-1" value=""></div>
